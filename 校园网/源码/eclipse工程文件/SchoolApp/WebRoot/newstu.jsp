...
<!-- 第四个框-->
  ...
  <h3 align="left" style="width:950px;background-color:#c0c0c0;border-radius:5px;margin-bottom:10px;">下载列表</h3>
<iframe src="NewstuServlet" width="680px" height="450px" scrolling="[OPTION]" frameborder="x"name="main">
</iframe>
  </div>
  <br class="spacer" />
</div>
